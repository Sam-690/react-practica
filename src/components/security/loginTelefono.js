...
class loginTelefono extends Component {
  ...
  loginConTelefono = () => {
    ...
    let credencial = firebase.authorization.PhoneAuthProvider.credencial(
    ...
    return (
      <Container maxWidth="xs">
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
              Ingrese el codigo recibido por mensaje de texto
            </DialogContentText>
            <TextField
              autoFocus
              margin="dense"
          ...
          <DialogActions>
            ...
            <Button color="primary">Verificar</Button>
          </DialogActions>
        </Dialog>
